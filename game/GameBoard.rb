...
class GameBoard
	...
	def place_game_pieces
		...
		@game_array[0][1] = Knight.new("black",[0,1])
		@game_array[0][6] = Knight.new("black",[0,6])
		...
		@game_array[7][1] = Knight.new("white",[0,1])
		@game_array[7][6] = Knight.new("white",[0,6])
	...
	def move_piece(array)
		...
		@game_array[to[0]][to[1]].position = to
	end
end
